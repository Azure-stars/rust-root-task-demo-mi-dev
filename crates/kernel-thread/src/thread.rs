...
use alloc::boxed::Box;
use sel4::{
    cap_type::Notification, debug_println, init_thread, set_ipc_buffer, CNodeCapData,
    CapTypeForFrameObjectOfFixedSize, Error, VmAttributes,
};
...
pub fn test_threads() {
    ...
    let secondary_thread_ipc_buffer_cap = OBJ_ALLOCATOR
        .lock()
